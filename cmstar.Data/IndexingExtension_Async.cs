...
namespace cmstar.Data
{
    ...
    public static partial class IndexingExtension
    {
        ...
        public static async Task<object> IxScalarAsync(this IDbClient client, string sql, params object[] param)
        {
        ...
        public static async Task<int> IxExecuteAsync(this IDbClient client, string sql, params object[] param)
        {
        ...
        public static async Task IxSizedExecuteAsync(this IDbClient client, int expectedSize, string sql, params object[] param)
        {
        ...
        public static async Task<DataTable> IxDataTableAsync(this IDbClient client, string sql, params object[] param)
        {
        ...
        /// <param name="param">参数表。</param>
        /// <returns>表示查询结果的<see cref="System.Data.DataTable"/>。</returns>
        public static async Task<DataSet> IxDataSetAsync(this IDbClient client, string sql, params object[] param)
        {
        ...
        public static async Task<bool> IxExistsAsync(this IDbClient client, string sql, params object[] param)
        {
        ...
        public static async Task<IDataRecord> IxGetRowAsync(this IDbClient client, string sql, params object[] param)
        {
        ...
        public static async Task<object[]> IxItemArrayAsync(this IDbClient client, string sql, params object[] param)
        {
        ...
        public static async Task<T> IxGetAsync<T>(this IDbClient client, IMapper<T> mapper, string sql, params object[] param)
        {
        ...
        public static async Task<T> IxForceGetAsync<T>(this IDbClient client, IMapper<T> mapper, string sql, params object[] param)
        {
        ...
        public static async Task<IList<T>> IxListAsync<T>(this IDbClient client, IMapper<T> mapper, string sql, params object[] param)
        {
        ...
        public static async Task<IEnumerable<IDataRecord>> IxRowsAsync(this IDbClient client, string sql, params object[] param)
        {
