...
namespace cmstar.Data
{
...
#endif
    {
        ...
        /// <param name="timeout">命令的超时时间，单位毫秒�?为不指定�?/param>
        /// <returns>查询结果的第一行第一列的值。若查询结果行数�?，返�?c>null</c>�?/returns>
        /// <exception cref="ArgumentNullException">�?paramref name="sql"/>�?c>null</c>�?/exception>
        /// <exception cref="ArgumentException">�?paramref name="sql"/>长度�?�?/exception>
        ...
        /// <summary>
        /// 返回查询语句对应查询结果�?see cref="System.Data.DataTable"/>�?
        /// </summary>
        /// <param name="sql">查询SQL�?/param>
        /// <param name="parameters">参数序列。空序列或null表示没有参数�?/param>
        /// <param name="commandType">命令的类型�?/param>
        /// <param name="timeout">命令的超时时间，单位毫秒�?为不指定�?/param>
        /// <returns>表示查询结果�?see cref="System.Data.DataTable"/>�?/returns>
        /// <exception cref="ArgumentNullException">�?paramref name="sql"/>�?c>null</c>�?/exception>
        /// <exception cref="ArgumentException">�?paramref name="sql"/>长度�?�?/exception>
        ...
        /// <summary>
        /// 返回查询语句对应查询结果�?see cref="System.Data.DataSet"/>�?
        /// </summary>
        /// <param name="sql">查询SQL�?/param>
        /// <param name="parameters">参数序列。空序列或null表示没有参数�?/param>
        /// <param name="commandType">命令的类型�?/param>
        /// <param name="timeout">命令的超时时间，单位毫秒�?为不指定�?/param>
        /// <returns>表示查询结果�?see cref="System.Data.DataSet"/>�?/returns>
        /// <exception cref="ArgumentNullException">�?paramref name="sql"/>�?c>null</c>�?/exception>
        /// <exception cref="ArgumentException">�?paramref name="sql"/>长度�?�?/exception>
        ...
        /// <param name="commandType">命令的类型�?/param>
        /// <param name="timeout">命令的超时时间，单位毫秒�?为不指定�?/param>
        /// <returns>若查询结果至少包�?行，返回<c>true</c>；否则返�?c>false</c>�?/returns>
        /// <exception cref="ArgumentNullException">�?paramref name="sql"/>�?c>null</c>�?/exception>
        /// <exception cref="ArgumentException">�?paramref name="sql"/>长度�?�?/exception>
        ...
        /// <exception cref="ArgumentException">�?paramref name="sql"/>长度�?�?/exception>
        /// <remarks>
        /// 区别�?see cref="DbCommand.ExecuteReader()"/>的用法，此方法执行完毕后将并不保持数据库连接�?
        /// 也不需要调�?see cref="IDisposable.Dispose"/>�?
        /// </remarks>
        ...
        /// 若满足条件的记录不存在，返回目标类型的默认值（对于引用类型�?c>null</c>）�?
        /// </summary>
        ...
        /// <param name="timeout">命令的超时时间，单位毫秒�?为不指定�?/param>
        /// <returns>目标类型的实例�?/returns>
        /// <exception cref="IncorrectResultSizeException">当SQL命中的记录行数不�?1�?/exception>
